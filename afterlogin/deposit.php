...
<body>
    <div>
        ...
        <main class="main-content">
            <section id="deposit" class="deposit-section" style="margin-bottom:100vh">
                <h2>Deposit Funds</h2>
                <div id="depositFormContainer">
                    <form id="depositForm" method="post" action="../includes/deposit.php">
                        <label for="amount">Amount:</label>
                        <input type="number" id="amount" name="amount" required>
                        <button type="submit">Deposit</button>
                    </form>
                    <p id="depositResponseMessage"></p>
                </div>
            </section>
        </main>
